...
const Register = () => {
  ...
  const getPasswordStrength = () => {
    if (!formData.password) return { width: '0%', color: 'var(--error-color)', text: '' };
    if (formData.password.length < 6) return { width: '30%', color: 'var(--error-color)', text: 'Weak' };
    if (formData.password.length < 10) return { width: '60%', color: '#f59e0b', text: 'Medium' };
    return { width: '100%', color: 'var(--success-color)', text: 'Strong' };
  };
        ...
        <div className="auth-left-panel">
          <div className="auth-left-content">
            ...
            <div className="auth-welcome">
              <h2>Join SupportHub Today</h2>
              <p>Create your account to get started with our support services</p>
            </div>
            <div className="auth-features">
              <div className="auth-feature">
                <FiCheck /> Quick issue resolution
              </div>
              <div className="auth-feature">
                <FiCheck /> Dedicated support agents
              </div>
              <div className="auth-feature">
                <FiCheck /> Priority ticket handling
              </div>
            </div>
          </div>
        </div>
              ...
              <div className={`form-group ${errors.password ? 'has-error' : ''}`}>
                ...
                <div className="password-strength">
                  ...
                  <span className="password-strength-text">
                    {formData.password ? passwordStrength.text : 'Minimum 6 characters'}
                  </span>
                </div>
              </div>
