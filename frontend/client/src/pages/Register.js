      ...
      <div className="auth-container">
        <div className="auth-left-panel">
          ...
          <div className="auth-welcome">
            ...
            <p>Get instant access to expert help and support resources</p>
          </div>
        </div>
            ...
            <form onSubmit={handleRegister} className="auth-form">
              ...
              <div className={`form-group ${errors.password ? 'has-error' : ''}`}>
                ...
                <div className="password-strength">
                  <div className={`strength-bar ${formData.password.length > 0 ? 'active' : ''} ${formData.password.length >= 8 ? 'strong' : ''}`}></div>
                  <span>{formData.password.length >= 8 ? 'Strong password' : 'Minimum 6 characters'}</span>
                </div>
              </div>
